  ...
  const ITEM_DEFS = {
    ...
    // 金ツール（本家準拠: 掘るのは最速だが耐久32、採掘可能ティアは木相当）
    gold_pickaxe:    { name: '金のツルハシ', cat: 'tool', tool: 'pickaxe', tier: 1, speed: 12, durability: 32, damage: 2 },
    ...
    gold_axe:        { name: '金の斧', cat: 'tool', tool: 'axe', tier: 1, speed: 12, durability: 32, damage: 3 },
    ...
    gold_shovel:     { name: '金のシャベル', cat: 'tool', tool: 'shovel', tier: 1, speed: 12, durability: 32, damage: 1 },
    ...
    gold_sword:    { name: '金の剣', cat: 'weapon', tool: 'sword', tier: 1, durability: 32, damage: 4 },
